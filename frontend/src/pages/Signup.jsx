...
//       <Container>
//         <div className={`mx-auto ${isDark ? 'bg-slate-900 border border-slate-700' : 'bg-white'} p-4 sm:p-6 md:p-8 rounded-xl shadow-lg w-full transition-colors`}>
...
//   return (
//     <div className={`min-h-screen flex items-center justify-center ${isDark ? 'bg-slate-950' : 'bg-slate-50'} px-4 sm:px-6 lg:px-8 py-6 transition-colors`}>
//       <Container>
...
//                         p-5 sm:p-6 md:p-8 lg:p-10 rounded-xl shadow-lg transition-colors`}>
          
//           {/* Header */}
//           <div className="text-center mb-5 sm:mb-6">
//             <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full 
//                             bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold mb-2 sm:mb-3 text-sm sm:text-base">
//               E
//             </div>
//             <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Create Your Account</h2>
//             <p className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>
...
//             {/* Name */}
//             <label className="block">
//               <span className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-300' : 'text-gray-600'}`}>Full name</span>
//               <input
//                 type="text"
//                 name="name"
//                 value={formData.name}
...
//                 placeholder="Your full name"
//                 required
//                 className={`mt-1 w-full px-3 py-2 sm:py-2.5 md:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 
//                             text-sm sm:text-base md:text-lg ${isDark ? 'bg-slate-800 border-slate-600 text-white' : 'bg-white border-gray-300 text-gray-900'} transition-colors`}
//               />
//             </label>

//             {/* Email */}
//             <label className="block">
//               <span className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-300' : 'text-gray-600'}`}>Email</span>
//               <input
//                 type="email"
//                 name="email"
//                 value={formData.email}
...
//                 placeholder="you@example.com"
//                 required
//                 className={`mt-1 w-full px-3 py-2 sm:py-2.5 md:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400
//                             text-sm sm:text-base md:text-lg ${isDark ? 'bg-slate-800 border-slate-600 text-white' : 'bg-white border-gray-300 text-gray-900'} transition-colors`}
//               />
//             </label>
...
//             {/* Phone Number */}
//             <label className="block">
//               <span className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-300' : 'text-gray-600'}`}>Phone Number</span>
//               <input
//                 type="tel"
//                 name="phoneNumber"
//                 value={formData.phoneNumber}
...
//               <label className="block">
//                 <span className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-300' : 'text-gray-600'}`}>Password</span>
//                 <input
//                   type="password"
//                   name="password"
//                   value={formData.password}
...
//               </label>
//               <label className="block">
//                 <span className={`text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-300' : 'text-gray-600'}`}>Confirm</span>
//                 <input
//                   type="password"
//                   name="confirmPassword"
//                   value={formData.confirmPassword}
...
//             {/* Terms */}
//             <label className={`flex items-start gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border-2 text-xs sm:text-sm md:text-base
//                               ${formData.agreeTerms ? (isDark ? 'bg-indigo-900/20 border-indigo-600' : 'bg-indigo-50 border-indigo-300') 
//                               : (isDark ? 'bg-slate-800 border-slate-600' : 'bg-gray-50 border-gray-300')} transition-colors cursor-pointer`}>
//               <input
//                 type="checkbox"
//                 name="agreeTerms"
//                 checked={formData.agreeTerms}
//                 onChange={handleChange}
//                 className={`mt-1 w-4 h-4 sm:w-5 sm:h-5 rounded cursor-pointer flex-shrink-0 ${isDark ? 'accent-indigo-500' : 'accent-indigo-600'}`}
//               />
//               <div className="flex-1">
//                 <span className={isDark ? 'text-slate-300' : 'text-gray-700'}>
//                   I agree to the{' '}
...
//               type="submit"
//               disabled={loading || !formData.agreeTerms}
//               className="w-full bg-indigo-600 text-white py-2.5 sm:py-3 md:py-3.5 rounded-lg font-semibold hover:bg-indigo-700 transition disabled:opacity-60 disabled:cursor-not-allowed text-sm sm:text-base md:text-lg"
//             >
//               {loading ? 'Creating Account...' : 'Sign Up Free'}
//             </button>
//           </form>
...
//           {/* Footer */}
//           <p className={`text-center mt-4 sm:mt-6 md:mt-8 text-xs sm:text-sm md:text-base ${isDark ? 'text-slate-400' : 'text-gray-600'}`}>
//             Already have an account?{' '}
//             <Link to="/login" className="text-green-600 font-semibold hover:underline">
//               Login here
//             </Link>
...
export default function Signup() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center 
                    ${isDark ? 'bg-slate-950' : 'bg-slate-50'} transition-colors py-6`}>
